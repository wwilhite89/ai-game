...
//                    c.Add(new Character { Name = "Ser Rodrick Cassel" });
                ...
                case House.HouseName.LANNISTER:
                    #region Lannister
					c.Add(new Character { Name = "Jaime Lannister", health = 24, attack = 20, defense = 8, evade = .15f, critical = .15f, movement = 3, range = 1, resourcePath="Jaime" });
					c.Add(new Character { Name = "The Hound", health = 28, attack = 15, defense = 15, evade = .05f, critical = .10f, movement = 2, range = 2, resourcePath="The Hound" });
//					c.Add(new Character { Name = "The Mountain", health = 10, attack = 5, defense = 5, evade = .05f, critical = .05f, movement = 2, range = 1, resourcePath="" });
					c.Add(new Character { Name = "Tywin Lannister", health = 25, attack = 12, defense = 12, evade = .10f, critical = .10f, movement = 2, range = 1, resourcePath="Tywin" });
